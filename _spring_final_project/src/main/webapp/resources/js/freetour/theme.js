...
if(themeTag == 1){
    ...
    theme_2.style.backgroundImage = "url(/resources/image/list-image/하와이.jpg)";
    ...
    theme_4.style.backgroundImage = "url(/resources/image/list-image/몰디브.jpg)";
    theme_info_4.innerHTML = "관광 레저 휴양 맛집 모든것이 가능한 이곳";
    theme_country_4.innerHTML ="발리";

    theme_5.style.backgroundImage = "url(/resources/image/list-image/몰디브.jpg)";
    theme_info_5.innerHTML = "아시아의 진주";
    theme_country_5.innerHTML ="푸켓";

    theme_6.style.backgroundImage = "url(/resources/image/list-image/몰디브.jpg)";
    ...
    theme_1.style.backgroundImage = "url(/resources/image/list-image/몰디브.jpg)";
    ...
    theme_3.style.backgroundImage = "url(/resources/image/list-image/몰디브.jpg)";
    ...
    theme_4.style.backgroundImage = "url(/resources/image/free-image/몰디브.jpg)";
